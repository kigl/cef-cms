...
class m170222_100317_infosystem_item_property extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createIndex('ix-infosystem_item_property-item_id', $this->tableName, 'item_id');
        $this->createIndex('ix-infosystem_item_property-property_id', $this->tableName, 'property_id');
