...
class m160825_111921_infosystem extends Migration
{
    ...
    public function up()
    {
        $this->createTable($this->tableName, [
            ...
            'sorting_attribute_group' => $this->string(100),
            'sorting_list_attribute_group' => $this->string(),
            'sorting_type_item' => $this->integer(),
            'sorting_attribute_item' => $this->string(100),
            'sorting_list_attribute_item' => $this->string(),
